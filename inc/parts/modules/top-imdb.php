...
$items = get_option('dt_topimdb_number_items','5');
$title = get_option('dt_imdbtop_title','Top IMDb');
$page = get_option('dt_topimdb_page');
// Movies and TV Top
if( get_option('dt_topimdb_layout') =='top_movies_tv') { ?>
<div class="top-imdb-list tleft">
<h3><?php _d('TOP Movies'); ?> <a class="see_all" href="<?php echo $page; ?>"><?php _d('See all'); ?></a></h3>
...
<h3><?php _d('TOP TV Shows'); ?> <a class="see_all" href="<?php echo $page; ?>"><?php _d('See all'); ?></a></h3>
<?php query_posts( array(

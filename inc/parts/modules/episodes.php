...
<header>
<h2><?php echo get_option('dt_me_title','Episodes'); ?></h2>
...
<?php } ?>
<span><?php echo total_episodios(); ?> <?php if($url = get_option('dt_episodes_slug','episodes')) { ?><a href="<?php echo esc_url( home_url() ) .'/'. $url .'/'; ?>" class="see-all"><?php _d('See all'); ?></a><?php } ?></span>
</header>
